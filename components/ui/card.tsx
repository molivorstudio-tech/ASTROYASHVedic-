...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-slate-300 leading-relaxed font-sans", className)}
    {...props}
  />
));
